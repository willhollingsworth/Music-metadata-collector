...
class ApiUrlBuilder:
    ...
    def __init__(
        ...
        """Initialize the ApiUrlBuilder with service name, request type, resource, and URL arguments.
        ...
        Args:
            ...
            url_args (list[str] | str): args for request (track id, album id, etc.).
    ...
    def build_full_url(self) -> str:
        ...
        Raises:
            TypeError: If the URL arguments format is not a string.
